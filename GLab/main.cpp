...
static void glfw_error_callback(int error, const char* description)
{
    ...
    ES::es.dispatch(ES::event(0, description));
}

void cursor_position_callback(GLFWwindow* window, double xpos, double ypos)
{
	_pl("cursor_position_callback");
}

void mouse_button_callback(GLFWwindow* window, int button, int action, int mods) {
	//_pl("mouse_button_callback: button ", button, " action ", action, " mods ", mods);
    ES::es.post(ES::event(11, (void*) window, button, action, mods));
}
...
void scroll_callback(GLFWwindow* window, double xoffset, double yoffset) {
    ...
    ES::es.dispatch(ES::event(9, xoffset, yoffset));
}
...
int main(int, char**)
{
    ...
    GLFWwindow* window = glfwCreateWindow(GLabWidth, GLabHeight, GLabTitle, NULL, NULL);
    if (window == NULL)
        return 1;
